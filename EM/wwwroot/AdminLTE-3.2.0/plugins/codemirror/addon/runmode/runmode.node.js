...
require.cache[require.resolve("~/AdminLTE-3.2.0/lib/codemirror")] = require.cache[require.resolve("./runmode.node")];
require.cache[require.resolve("~/AdminLTE-3.2.0/addon/runmode/runmode")] = require.cache[require.resolve("./runmode.node")];
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    { mod(require("~/AdminLTE-3.2.0/lib/codemirror")); }
  else if (typeof define == "function" && define.amd) // AMD
    { define(["~/AdminLTE-3.2.0/lib/codemirror"], mod); }
