...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    mod(require("~/AdminLTE-3.2.0/lib/codemirror"), require("../htmlmixed/htmlmixed"), require("../clike/clike"));
  else if (typeof define == "function" && define.amd) // AMD
    define(["~/AdminLTE-3.2.0/lib/codemirror", "../htmlmixed/htmlmixed", "../clike/clike"], mod);
